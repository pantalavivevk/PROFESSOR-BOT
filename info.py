...
# PyroClient Setup 
API_ID = int(environ['72911888'])
API_HASH = environ['92c78baef31ad68a00a32e983d238277']
...
auth_channel = environ.get('-1001939226442')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://mmnrenamer:mmn4renamer@cluster0.2llmgyv.mongodb.net/?retryWrites=true&w=majority")
